...
const CartTab = ({}) => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 bg-gray-700 shadow-2xl w-[360px] h-full grid grid-rows-[60px_1fr_60px] 
            transform transition-transform duration-500
            ${isCartTabOpen ? "" : "translate-x-full"}`}
    >
      <h2 className="flex items-center justify-center font-semibold font-sans text-white text-2xl">
        SHOPPING CART
      </h2>
      <div>
        {carts.map((item, key) => (
